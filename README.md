...
as a side note my windows machine changed IP as I updated the ethernet port and did not have a static IP set for the new card. Old IP (10.0.0.2) New IP (10.0.0.212)
### Incident Responses
